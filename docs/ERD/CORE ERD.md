...
### 3-3. USER_PREFERENCE_PROFILES (선호도 프로파일)
...
### 4-3. BAR_CATEGORY_MAPPING (다대다 매핑)
...
### 7-2. PARTY_PLAN_STOPS (플랜 내 코스/장소)
